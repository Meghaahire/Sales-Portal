<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="CreateSales.aspx.cs" Inherits="SalesManagementPortal.CreateSales" %>
        ...
        <div>
          ...
          <asp:GridView ID="GridView1" runat="server" 
            ...
            <asp:SqlDataSource ID="LibraryDb" runat="server" ConnectionString='<%$ ConnectionStrings:SalePortalConnectionString %>'
                ProviderName='<%$ ConnectionStrings:SalePortalConnectionString.ProviderName %>' SelectCommand="SELECT * FROM [Users_Table]"
