<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Comments.aspx.cs" Inherits="SalesManagementPortal.Comments" %>
        ...
        <div>
          ...
          <asp:GridView ID="GridView1" runat="server" 
            ...
            <asp:SqlDataSource ID="LibraryDb" runat="server" ConnectionString='<%$ ConnectionStrings:SalePortalConnectionString %>' 
                SelectCommand="SELECT * FROM [Announcement_table]"
