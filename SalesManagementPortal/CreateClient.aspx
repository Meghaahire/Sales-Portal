<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="CreateClient.aspx.cs" Inherits="SalesManagementPortal.CreateClient" %>
    ...
    <center>
        <div>
                    ...
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success table-responsive ">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:SqlDataSource ID="SalesDb" runat="server" ConnectionString='<%$ ConnectionStrings:SalePortalConnectionString %>'
                                    SelectCommand="SELECT * FROM [OppType_Table]"></asp:SqlDataSource>
          ...
          <asp:GridView ID="GridView1" runat="server" 
            ...
            <asp:SqlDataSource ID="LibraryDb" runat="server" ConnectionString='<%$ ConnectionStrings:SalePortalConnectionString %>'></asp:SqlDataSource>
        </div>
    </center>
