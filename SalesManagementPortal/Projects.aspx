<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Projects.aspx.cs" Inherits="SalesManagementPortal.Projects" %>
        ...
        <div>
          ...
          <asp:GridView ID="GridView1" runat="server" 
            ...
            <asp:SqlDataSource ID="LibraryDb" runat="server" ConnectionString='<%$ ConnectionStrings:SalePortalConnectionString %>' 
                SelectCommand="SELECT * FROM [Project_Table]"   
